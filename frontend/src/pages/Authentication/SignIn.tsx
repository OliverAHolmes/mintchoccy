...
import LogoDark from '../../images/logo/mint-choccy-logo.png';
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            ...
            <p className="2xl:px-20">
              Make your CRM more efficient with Mint Choccy. Manage your
              customers, leads, and deals with ease.
            </p>
