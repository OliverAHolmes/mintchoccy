...
export class MintFrontend extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);
    const siteUrl = `app.mintchoccy.com`;

    const bucket = new s3.Bucket(this, `MintAppBucket`, {
      bucketName: `mint-frontend-cdk`,
      removalPolicy: cdk.RemovalPolicy.DESTROY,
    });

    // Deploy the React app to the S3 bucket
    new s3deploy.BucketDeployment(this, 'MintFrontendDeployment', {
    ...
    const certificate = acm.Certificate.fromCertificateArn(
      ...
      'arn:aws:acm:us-east-1:208792096778:certificate/d5b1fcbc-6900-483d-b9d9-e07f3744ff3a',
    );
